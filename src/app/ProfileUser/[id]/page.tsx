...
export default function ProfileUser() {
  ...
  <div className="flex flex-col items-center justify-center p-10">
  <p className="text-2xl font-semibold text-red-500">Profile not found.</p>
  </div>
  ) : (
  <>
  {/* Profile Header */}
  {isOwnAccount && (
  <h4 className="text-3xl p-2">Your Profile</h4>
  )}
  {/* Profile Details */}
  <div className="text-center mt-4 w-full">
  <Image
  src={profileData.profileImage && profileData.profileImage !== "" ? profileData.profileImage : icon}
  alt="User Profile"
  ...
  <span className="block mt-2 text-lg">Likes: {profileData.Like}</span>
  </li>
  </ul>
  </div>
  {/* Followers Section */}
