      ...
      <form onSubmit={(e) => e.preventDefault()} className="relative group">
        <div className="relative">
          <input
            ...
            className="w-full pl-12 text-black pr-12 py-4 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl focus:ring-2 focus:ring-blue-500 shadow-lg outline-none transition-all"
          />
